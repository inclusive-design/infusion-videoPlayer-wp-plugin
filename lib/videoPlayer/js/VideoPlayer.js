...
console.log("========= checking if we're in full-screen");
    if (fullscreenEl) {
console.log("========= we are!");
        // we have entered fullscreen model.
        $(fullscreenEl).keydown(function (evt) {
console.log(">>>> got keydown on fullscreenEl");
            var code = evt.which ? evt.which : evt.keyCode;
            if (code === that.options.keyBindings.escape.key) {
...
console.log(">>>> isFullScreenRightNow = "+isFullScreenRightNow+", model.fullscreen = "+that.model.fullscreen);
